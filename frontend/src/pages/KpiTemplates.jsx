                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-slate-100 pb-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 text-[10px] font-bold text-sky-700 hover:bg-sky-50 border border-sky-100 px-3 py-1.5 rounded-lg cursor-pointer transition-colors shadow-3xs"
                    >
                      <Plus size={12} />
                  ...
                  <div className="space-y-4 pr-1">
                    {items.map((item, idx) => (
                      <div key={idx} className="bg-slate-50 border border-slate-200 rounded-xl p-4.5 space-y-3 relative group">
                        <div className="grid grid-cols-12 gap-3 pr-6">
                          <div className="col-span-12 md:col-span-6 space-y-1">
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-slate-200 text-xs p-2.5 rounded-lg outline-none focus:border-sky-500 text-slate-800 font-semibold shadow-3xs"
                              required
                            />
                          </div>
                          ...
                          <div className="col-span-8 md:col-span-4 space-y-1">
                            ...
                            <select
                              ...
                              className="w-full bg-white border border-slate-200 text-xs p-2.5 rounded-lg outline-none focus:border-sky-500 text-slate-700 font-bold shadow-3xs"
                            >
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            className="w-full bg-white border border-slate-200 text-xs p-2.5 rounded-lg outline-none focus:border-sky-500 text-slate-650 resize-none shadow-3xs leading-relaxed"
                          />
                        </div>
